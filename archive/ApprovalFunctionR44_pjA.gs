 ...
 *
 * 
 * takuya hayashi, last update 01/May/2025
 * 
 */
...
function ApprovalFunctionR4() {
  ...
  if (myFlag == true && myCol == checkBoxCols1) {
    ...
    //発注確定項目の品目のプロパティ取得　＊オリジナル処理から効率化: Rev.4#2
	
	//オリジナル処理から効率化: Rev.4#2: 「Exceeded maximum execution time」対策の改修
	...
	//＊旧メール送信メソッド：”GmailApp”メール送信メソッドの変更　＊Rev.4#1改修
	...
	try{
		...
		//＊新メール送信メソッド：”MailApp”メール送信メソッドへの変更　＊Rev.4#1改修
    ...
    */ //以上、コメントアウト：Rev.1------------------------------------------
	...
	//＊旧メール送信メソッド：”Gmail.App”メール送信メソッドの変更　＊Rev.4#1改修
